...
-- Add constraint to license_pools if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE constraint_name = 'license_pools_type_check'
    AND table_name = 'license_pools'
  ) THEN
    ALTER TABLE license_pools ADD CONSTRAINT license_pools_type_check 
    CHECK (type = ANY (ARRAY['sophos'::text, 'server'::text, 'windows'::text]));
  END IF;
END $$;
...
-- Add constraints to license_assignments if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE constraint_name = 'license_assignments_type_check'
    AND table_name = 'license_assignments'
  ) THEN
    ALTER TABLE license_assignments ADD CONSTRAINT license_assignments_type_check 
    CHECK (type = ANY (ARRAY['sophos'::text, 'server'::text, 'windows'::text]));
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE license_assignments ADD CONSTRAINT license_assignments_pool_id_fkey 
...
BEGIN
  IF NOT EXISTS (
    ...
    AND table_name = 'microsoft365_users'
  ) THEN
...
-- Add constraint to legacy_licenses if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE constraint_name = 'legacy_licenses_type_check'
    AND table_name = 'legacy_licenses'
  ) THEN
    ALTER TABLE legacy_licenses ADD CONSTRAINT legacy_licenses_type_check 
    CHECK (type = ANY (ARRAY['microsoft365'::text, 'sophos'::text, 'server'::text, 'windows'::text]));
  END IF;
END $$;
...
-- Create RLS policies for license_pools (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_pools' 
    AND policyname = 'Usuários autenticados podem ver pools de licenças'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_pools' 
    AND policyname = 'Usuários autenticados podem inserir pools de licenças'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_pools' 
    AND policyname = 'Usuários autenticados podem atualizar pools de licenças'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_pools' 
    AND policyname = 'Usuários autenticados podem deletar pools de licenças'
  ) THEN
...
-- Create RLS policies for license_assignments (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_assignments' 
    AND policyname = 'Usuários autenticados podem ver atribuições de licenças'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_assignments' 
    AND policyname = 'Usuários autenticados podem inserir atribuições de licenças'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_assignments' 
    AND policyname = 'Usuários autenticados podem atualizar atribuições de licenç'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'license_assignments' 
    AND policyname = 'Usuários autenticados podem deletar atribuições de licenças'
  ) THEN
...
-- Create RLS policies for microsoft365_pools (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_pools' 
    AND policyname = 'Usuários autenticados podem ver pools Microsoft 365'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_pools' 
    AND policyname = 'Usuários autenticados podem inserir pools Microsoft 365'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_pools' 
    AND policyname = 'Usuários autenticados podem atualizar pools Microsoft 365'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_pools' 
    AND policyname = 'Usuários autenticados podem deletar pools Microsoft 365'
  ) THEN
...
-- Create RLS policies for microsoft365_users (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_users' 
    AND policyname = 'Usuários autenticados podem ver usuários Microsoft 365'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_users' 
    AND policyname = 'Usuários autenticados podem inserir usuários Microsoft 365'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_users' 
    AND policyname = 'Usuários autenticados podem atualizar usuários Microsoft 365'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'microsoft365_users' 
    AND policyname = 'Usuários autenticados podem deletar usuários Microsoft 365'
  ) THEN
...
-- Create RLS policies for legacy_licenses (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'legacy_licenses' 
    AND policyname = 'Usuários autenticados podem ver licenças legadas'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'legacy_licenses' 
    AND policyname = 'Usuários autenticados podem inserir licenças legadas'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'legacy_licenses' 
    AND policyname = 'Usuários autenticados podem atualizar licenças legadas'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'legacy_licenses' 
    AND policyname = 'Usuários autenticados podem deletar licenças legadas'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE trigger_name = 'update_license_pools_updated_at'
    AND event_object_table = 'license_pools'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.triggers 
    WHERE trigger_name = 'update_license_assignments_updated_at'
    AND event_object_table = 'license_assignments'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.triggers 
    WHERE trigger_name = 'update_microsoft365_pools_updated_at'
    AND event_object_table = 'microsoft365_pools'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.triggers 
    WHERE trigger_name = 'update_microsoft365_users_updated_at'
    AND event_object_table = 'microsoft365_users'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.triggers 
    WHERE trigger_name = 'update_legacy_licenses_updated_at'
    AND event_object_table = 'legacy_licenses'
  ) THEN
